...
function TryxLib:CreateWindow(config)
    ...
    padding(topBar, 0, 0, 12, 12)

    local iconLabel = label(topBar, icon, theme.Accent, 13, Enum.Font.GothamBold)
    iconLabel.Size  = UDim2.new(0, 14, 1, 0)
    iconLabel.Name  = "Icon"
    iconLabel.TextXAlignment = Enum.TextXAlignment.Center

    local titleLabel = label(topBar, title, theme.TextPrimary, 12, Enum.Font.GothamBold)
    titleLabel.Size  = UDim2.new(1, -80, 1, 0)
    titleLabel.Name  = "Title"

    local btnContainer = newFrame(topBar, Color3.fromRGB(0, 0, 0), UDim2.new(0, 44, 1, 0))
    ...
    corner(resizeHandle, UDim.new(0, 4))
    ...
    function Window:Tab(cfg)
        ...
        local iconLbl = label(tabBtn, tabIcon, theme.Accent, 11, Enum.Font.GothamMedium)
        iconLbl.Size  = UDim2.new(0, 13, 1, 0)
        iconLbl.TextXAlignment = Enum.TextXAlignment.Center

        local titleLbl = label(tabBtn, tabTitle, theme.TextSecondary, 11, Enum.Font.GothamMedium)
